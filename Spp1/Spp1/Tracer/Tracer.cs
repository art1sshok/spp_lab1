...
namespace Trace { 
    ...
    class Method : IMethod{
        ...
        public MethodBase MethodBase => stackTrace.GetFrame(1).GetMethod();
    ...
    public class Tracer : ITracer{
        ...
        public IEnumerable<IThreadNode> GetResult(){
            lock(pairs){
                var nodes = new List<IThreadNode>();
